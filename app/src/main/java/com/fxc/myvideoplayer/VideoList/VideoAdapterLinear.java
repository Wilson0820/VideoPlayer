...
public class VideoAdapterLinear extends RecyclerView.Adapter<VideoAdapterLinear.ViewHolder> {
    Context context;
    List<VideoItems> videos;
    private ArrayList<String> moviepathlist;

    public VideoAdapterLinear(Context context, List<VideoItems> videos, ArrayList<String> moviepathlist) {
